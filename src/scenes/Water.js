...
class Water extends Phaser.Scene {
    ...
    create() {
        ...
        //BACKGROUND
        this.side_box_1 = this.add.rectangle(0, canvas_height / 2, canvas_width / 2, canvas_height, 0xFFFFFF);
        this.side_box_1.setDepth(7);
        this.side_box_2 = this.add.rectangle(canvas_width, canvas_height / 2, canvas_width / 2, canvas_height, 0xFFFFFF);
        this.side_box_2.setDepth(7);
        //have two backgrounds that loop 
        this.bg_air_1 = this.add.sprite(canvas_width / 2, -(canvas_height / 2), 'bg_air');
        this.bg_air_2 = this.add.sprite(canvas_width / 2, canvas_height / 2, 'bg_air');
        ...
        this.box_below_barrier = this.add.rectangle(canvas_width / 2, 1200, canvas_width / 2, canvas_height, 0xFFFFFF);
        ...
        this.faller_instance = new Faller(this, game.config.width / 2, canvas_height / 8, 'faller').setOrigin(0, 0);
    ...
    addObstacle() {
        ...
        //see stage bounds
        let obstacle = new Obstacle(this, Phaser.Math.Between(stageLeftBound + 40, stageRightBound), canvas_height, //or obstacle_height if horizontal stage
